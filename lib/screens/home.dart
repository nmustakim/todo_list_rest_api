...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title:  Text("Todos",style: titleTextStyle1,),
          centerTitle: true,
          elevation: 0,
          ...
          child: Visibility(
              ...
              child: Stack(
                  children: [
                    ...
                    searchController.text.isNotEmpty && searchList!.isEmpty ? const Center(child: Text("No todos found"),):
                    ...
                    Container(
                      ...
                      child:ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return TodoTile(text: todo.title, icon: todo.completed ?  Icons.check_box_outlined : Icons.check_box_outline_blank_outlined
                            );
                          }),
                    ):todosList!.isEmpty? const Center(child: Text("No todos here"),):
                    Container(
                      margin: const EdgeInsets.only(top: 120),
                      padding: const EdgeInsets.only(top: 20),
                      height: MediaQuery.of(context).size.height/1.1,
